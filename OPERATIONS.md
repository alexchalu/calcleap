...
## Current State (last updated: 2026-05-24 by Claude/evening-routine)
...
| Calculators with verified math | 130 audited (50 state property tax + 50 state sales tax + 30 state income tax — 9 no-tax states + IL + MI + NC + GA + AZ + CO + IN + KY + MA + MS + UT + ND + LA + IA + AL + VA + MO + OK + AR + NE + WV + SC + KS flat/bracketed; 14 income-tax state files still flagged needing per-state brackets) | 2,800 | Large |
