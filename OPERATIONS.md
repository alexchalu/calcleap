...
| Calculators with verified math | 142 audited (50 state property tax + 50 state sales tax + 42 state income tax — 9 no-tax states + IL + MI + NC + GA + AZ + CO + IN + KY + MA + MS + UT + ND + LA + IA + AL + VA + MO + OK + AR + NE + WV + SC + KS + ID + NJ + WI + MT + RI + NM + OR + ME + DE + HI + MN + VT flat/bracketed; 2 income-tax state files (CT + MD) still flagged needing per-state brackets) | 2,800 | Large |
