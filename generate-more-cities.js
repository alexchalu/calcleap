...
// 20 more US cities (mid-size with high relocation interest)
const cities = [
  { name: 'Atlanta', state: 'GA', col: 101, rent: 1700, avgIncome: 68000 },
  { name: 'Tampa', state: 'FL', col: 99, rent: 1800, avgIncome: 58000 },
  { name: 'Raleigh', state: 'NC', col: 98, rent: 1600, avgIncome: 70000 },
  { name: 'Minneapolis', state: 'MN', col: 104, rent: 1700, avgIncome: 72000 },
  { name: 'Orlando', state: 'FL', col: 100, rent: 1700, avgIncome: 56000 },
  { name: 'Sacramento', state: 'CA', col: 130, rent: 1900, avgIncome: 68000 },
  { name: 'Pittsburgh', state: 'PA', col: 90, rent: 1300, avgIncome: 60000 },
  { name: 'Cincinnati', state: 'OH', col: 88, rent: 1200, avgIncome: 56000 },
  { name: 'Kansas City', state: 'MO', col: 91, rent: 1300, avgIncome: 58000 },
  { name: 'Cleveland', state: 'OH', col: 86, rent: 1100, avgIncome: 52000 },
  { name: 'Omaha', state: 'NE', col: 91, rent: 1200, avgIncome: 58000 },
  { name: 'Reno', state: 'NV', col: 109, rent: 1500, avgIncome: 60000 },
  { name: 'Salt Lake City', state: 'UT', col: 106, rent: 1600, avgIncome: 65000 },
  { name: 'Richmond', state: 'VA', col: 96, rent: 1400, avgIncome: 60000 },
  { name: 'New Orleans', state: 'LA', col: 94, rent: 1400, avgIncome: 52000 },
  { name: 'Louisville', state: 'KY', col: 89, rent: 1200, avgIncome: 54000 },
  { name: 'Oklahoma City', state: 'OK', col: 87, rent: 1100, avgIncome: 52000 },
  { name: 'Buffalo', state: 'NY', col: 91, rent: 1200, avgIncome: 54000 },
  { name: 'Rochester', state: 'NY', col: 92, rent: 1200, avgIncome: 56000 },
  { name: 'Boise', state: 'ID', col: 105, rent: 1500, avgIncome: 58000 },
];
...
console.log(`\n✅ Generated ${count} additional city cost-of-living calculators`);
console.log('📊 Total cities now: 50 (30 original + 20 new)');
